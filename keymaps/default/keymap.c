...
led_config_t g_led_config = { {
    ...
    { 24, 25, 26, 27, 28, 29 },
    { NO_LED, NO_LED, NO_LED, NO_LED, NO_LED, NO_LED },      // Row 4 left
    ...
    { NO_LED, NO_LED, NO_LED, NO_LED, NO_LED, NO_LED }  // Row 4 right (encoder buttons, no LEDs)
}, {
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    */
    [0] = LAYOUT(
        ...
        XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,      RM_TOGG, KC_MPLY, KC_MUTE, KC_MPLY,  XXXXXXX,  XXXXXXX
    ),
